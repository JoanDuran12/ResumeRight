        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row ">
              <a
                className="bg-black text-white items-center inline-flex justify-center gap-2 text-sm font-medium hover:underline underline-offset-4 h-11 rounded-md px-8"
                href=""
              >
                Build Your Resume
          ...
          <div className="flex items-center justify-center">
            <div className="relative w-full max-w-[500px] ">
              <img
                ...
                src="https://writelatex.s3.amazonaws.com/published_ver/16158.jpeg?X-Amz-Expires=14400&X-Amz-Date=20250319T191308Z&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAWJBOALPNFPV7PVH5/20250319/us-east-1/s3/aws4_request&X-Amz-SignedHeaders=host&X-Amz-Signature=dd2c1a58e3fa3646a18ec5b0761ed91c5e0b313930541836b6d888b2de3b996e"
                alt=""
              />
            </div>
          </div>
